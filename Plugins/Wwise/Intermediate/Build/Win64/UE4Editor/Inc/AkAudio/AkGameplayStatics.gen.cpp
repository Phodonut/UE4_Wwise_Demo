...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_PanningRule(PanningRule_StaticEnum, TEXT("/Script/AkAudio"), TEXT("PanningRule"), false, nullptr, nullptr);
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_IsEditor()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("IsEditor"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), nullptr, (EFunctionFlags)0x04022401, 65535, sizeof(AkGameplayStatics_eventIsEditor_Parms));
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(ReturnValue, AkGameplayStatics_eventIsEditor_Parms);
			UProperty* NewProp_ReturnValue = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ReturnValue"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(ReturnValue, AkGameplayStatics_eventIsEditor_Parms), 0x0010000000000580, CPP_BOOL_PROPERTY_BITMASK(ReturnValue, AkGameplayStatics_eventIsEditor_Parms), sizeof(bool), true);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_IsGame()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("IsGame"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), nullptr, (EFunctionFlags)0x04022401, 65535, sizeof(AkGameplayStatics_eventIsGame_Parms));
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(ReturnValue, AkGameplayStatics_eventIsGame_Parms);
			UProperty* NewProp_ReturnValue = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ReturnValue"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(ReturnValue, AkGameplayStatics_eventIsGame_Parms), 0x0010000000000580, CPP_BOOL_PROPERTY_BITMASK(ReturnValue, AkGameplayStatics_eventIsGame_Parms), sizeof(bool), true);
			UProperty* NewProp_WorldContextObject = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("WorldContextObject"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(WorldContextObject, AkGameplayStatics_eventIsGame_Parms), 0x0010000000000080, Z_Construct_UClass_UObject_NoRegister());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_SetMultipleChannelEmitterPositions()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("SetMultipleChannelEmitterPositions"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), nullptr, (EFunctionFlags)0x04022401, 65535, sizeof(AkGameplayStatics_eventSetMultipleChannelEmitterPositions_Parms));
			UProperty* NewProp_MultiPositionType = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("MultiPositionType"), RF_Public|RF_Transient|RF_MarkAsNative) UEnumProperty(CPP_PROPERTY_BASE(MultiPositionType, AkGameplayStatics_eventSetMultipleChannelEmitterPositions_Parms), 0x0010000000000080, Z_Construct_UEnum_AkAudio_AkMultiPositionType());
			UProperty* NewProp_MultiPositionType_Underlying = new(EC_InternalUseOnlyConstructor, NewProp_MultiPositionType, TEXT("UnderlyingType"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000);
			UProperty* NewProp_Positions = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Positions"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(Positions, AkGameplayStatics_eventSetMultipleChannelEmitterPositions_Parms), 0x0010000000000080);
			UProperty* NewProp_Positions_Inner = new(EC_InternalUseOnlyConstructor, NewProp_Positions, TEXT("Positions"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000, Z_Construct_UScriptStruct_FTransform());
			UProperty* NewProp_ChannelMasks = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ChannelMasks"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(ChannelMasks, AkGameplayStatics_eventSetMultipleChannelEmitterPositions_Parms), 0x0010000000000080);
			UProperty* NewProp_ChannelMasks_Inner = new(EC_InternalUseOnlyConstructor, NewProp_ChannelMasks, TEXT("ChannelMasks"), RF_Public|RF_Transient|RF_MarkAsNative) UEnumProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000, Z_Construct_UEnum_AkAudio_AkChannelConfiguration());
			UProperty* NewProp_ChannelMasks_Inner_Underlying = new(EC_InternalUseOnlyConstructor, NewProp_ChannelMasks_Inner, TEXT("UnderlyingType"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000);
			UProperty* NewProp_GameObjectAkComponent = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("GameObjectAkComponent"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(GameObjectAkComponent, AkGameplayStatics_eventSetMultipleChannelEmitterPositions_Parms), 0x0010000000080080, Z_Construct_UClass_UAkComponent_NoRegister());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnFunction, TEXT("Category"), TEXT("Audiokinetic"));
			MetaData->SetValue(ReturnFunction, TEXT("CPP_Default_MultiPositionType"), TEXT("MultiDirections"));
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("Classes/AkGameplayStatics.h"));
			MetaData->SetValue(ReturnFunction, TEXT("ToolTip"), TEXT("Sets multiple positions to a single game object, with flexible assignment of input channels.\nSetting multiple positions on a single game object is a way to simulate multiple emission sources while using the resources of only one voice.\nThis can be used to simulate wall openings, area sounds, or multiple objects emitting the same sound in the same area.\nNote: Calling AK::SoundEngine::SetMultiplePositions() with only one position is the same as calling AK::SoundEngine::SetPosition()\n@param GameObjectAkComponent AkComponent of the game object on which to set positions.\n@param ChannelMasks Array of channel masks to apply for each position.\n@param Positions Array of transforms to apply.\n@param MultiPositionType Position type\n@return AK_Success when successful, AK_InvalidParameter if parameters are not valid."));
			MetaData->SetValue(NewProp_GameObjectAkComponent, TEXT("EditInline"), TEXT("true"));
#endif
		}
		return ReturnFunction;
	}
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_SetMultiplePositions()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("SetMultiplePositions"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), nullptr, (EFunctionFlags)0x04022401, 65535, sizeof(AkGameplayStatics_eventSetMultiplePositions_Parms));
			UProperty* NewProp_MultiPositionType = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("MultiPositionType"), RF_Public|RF_Transient|RF_MarkAsNative) UEnumProperty(CPP_PROPERTY_BASE(MultiPositionType, AkGameplayStatics_eventSetMultiplePositions_Parms), 0x0010000000000080, Z_Construct_UEnum_AkAudio_AkMultiPositionType());
			UProperty* NewProp_MultiPositionType_Underlying = new(EC_InternalUseOnlyConstructor, NewProp_MultiPositionType, TEXT("UnderlyingType"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000);
			UProperty* NewProp_Positions = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Positions"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(Positions, AkGameplayStatics_eventSetMultiplePositions_Parms), 0x0010000000000080);
			UProperty* NewProp_Positions_Inner = new(EC_InternalUseOnlyConstructor, NewProp_Positions, TEXT("Positions"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000, Z_Construct_UScriptStruct_FTransform());
			UProperty* NewProp_GameObjectAkComponent = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("GameObjectAkComponent"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(GameObjectAkComponent, AkGameplayStatics_eventSetMultiplePositions_Parms), 0x0010000000080080, Z_Construct_UClass_UAkComponent_NoRegister());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
			...
			MetaData->SetValue(ReturnFunction, TEXT("CPP_Default_MultiPositionType"), TEXT("MultiDirections"));
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("Classes/AkGameplayStatics.h"));
			MetaData->SetValue(ReturnFunction, TEXT("ToolTip"), TEXT("Sets multiple positions to a single game object.\nSetting multiple positions on a single game object is a way to simulate multiple emission sources while using the resources of only one voice.\nThis can be used to simulate wall openings, area sounds, or multiple objects emitting the same sound in the same area.\nNote: Calling SetMultiplePositions() with only one position is the same as calling SetPosition()\n@param GameObjectAkComponent AkComponent of the game object on which to set positions.\n@param Positions Array of transforms to apply.\n@param MultiPositionType Position type\n@return AK_Success when successful, AK_InvalidParameter if parameters are not valid."));
			MetaData->SetValue(NewProp_GameObjectAkComponent, TEXT("EditInline"), TEXT("true"));
#endif
		}
		return ReturnFunction;
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_UseEarlyReflections()
	{
		...
		if (!ReturnFunction)
		{
			...
			UProperty* NewProp_MaxPathLength = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("MaxPathLength"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(MaxPathLength, AkGameplayStatics_eventUseEarlyReflections_Parms), 0x0010000000000080);
			UProperty* NewProp_BusSendGain = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("BusSendGain"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(BusSendGain, AkGameplayStatics_eventUseEarlyReflections_Parms), 0x0010000000000080);
			UProperty* NewProp_Order = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Order"), RF_Public|RF_Transient|RF_MarkAsNative) UUnsizedIntProperty(CPP_PROPERTY_BASE(Order, AkGameplayStatics_eventUseEarlyReflections_Parms), 0x0010000000000080);
			...
			MetaData->SetValue(ReturnFunction, TEXT("AdvancedDisplay"), TEXT("6"));
			MetaData->SetValue(ReturnFunction, TEXT("Category"), TEXT("Audiokinetic|Actor"));
			MetaData->SetValue(ReturnFunction, TEXT("CPP_Default_BusSendGain"), TEXT("1.000000"));
			MetaData->SetValue(ReturnFunction, TEXT("CPP_Default_MaxPathLength"), TEXT("100000.000000"));
			MetaData->SetValue(ReturnFunction, TEXT("CPP_Default_Order"), TEXT("1"));
			MetaData->SetValue(ReturnFunction, TEXT("CPP_Default_SpotReflectors"), TEXT("false"));
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("Classes/AkGameplayStatics.h"));
	...
	UClass* Z_Construct_UClass_UAkGameplayStatics()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->LinkChild(Z_Construct_UFunction_UAkGameplayStatics_IsEditor());
				OuterClass->LinkChild(Z_Construct_UFunction_UAkGameplayStatics_IsGame());
				...
				OuterClass->LinkChild(Z_Construct_UFunction_UAkGameplayStatics_SetMultipleChannelEmitterPositions());
				OuterClass->LinkChild(Z_Construct_UFunction_UAkGameplayStatics_SetMultiplePositions());
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_IsEditor(), "IsEditor"); // 1229489931
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_IsGame(), "IsGame"); // 1506456172
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_SetMultipleChannelEmitterPositions(), "SetMultipleChannelEmitterPositions"); // 2545774111
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_SetMultiplePositions(), "SetMultiplePositions"); // 2264986655
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_UseEarlyReflections(), "UseEarlyReflections"); // 31966515
	...
	IMPLEMENT_CLASS(UAkGameplayStatics, 2088827721);
