...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_AkAcousticPortalState(AkAcousticPortalState_StaticEnum, TEXT("/Script/AkAudio"), TEXT("AkAcousticPortalState"), false, nullptr, nullptr);
	...
	UFunction* Z_Construct_UFunction_AAkAcousticPortal_ClosePortal()
	{
		...
		if (!ReturnFunction)
		{
			...
			MetaData->SetValue(ReturnFunction, TEXT("Category"), TEXT("Audiokinetic|AkAcousticPortal"));
	...
	UClass* Z_Construct_UClass_AAkAcousticPortal()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_ObstructionCollisionChannel = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ObstructionCollisionChannel"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(CPP_PROPERTY_BASE(ObstructionCollisionChannel, AAkAcousticPortal), 0x0010000000000005, Z_Construct_UEnum_Engine_ECollisionChannel());
				UProperty* NewProp_ObstructionRefreshInterval = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ObstructionRefreshInterval"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(ObstructionRefreshInterval, AAkAcousticPortal), 0x0010000000000005);
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_AAkAcousticPortal_ClosePortal(), "ClosePortal"); // 829388889
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_AAkAcousticPortal_GetCurrentState(), "GetCurrentState"); // 1681902116
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_AAkAcousticPortal_OpenPortal(), "OpenPortal"); // 1262720100
				...
				MetaData->SetValue(NewProp_ObstructionCollisionChannel, TEXT("Category"), TEXT("AkAcousticPortal"));
				MetaData->SetValue(NewProp_ObstructionCollisionChannel, TEXT("ModuleRelativePath"), TEXT("Classes/AkAcousticPortal.h"));
				MetaData->SetValue(NewProp_ObstructionCollisionChannel, TEXT("ToolTip"), TEXT("Collision channel for obstruction checks (between listener and portal opening)."));
				MetaData->SetValue(NewProp_ObstructionRefreshInterval, TEXT("Category"), TEXT("AkAcousticPortal"));
				MetaData->SetValue(NewProp_ObstructionRefreshInterval, TEXT("ModuleRelativePath"), TEXT("Classes/AkAcousticPortal.h"));
				MetaData->SetValue(NewProp_ObstructionRefreshInterval, TEXT("ToolTip"), TEXT("Time interval between obstruction checks (between listener and portal opening). Set to 0 to disable occlusion on this component."));
	...
	IMPLEMENT_CLASS(AAkAcousticPortal, 3246840013);
	...
	UClass* Z_Construct_UClass_UAkPortalComponent()
	{
		...
		if (!OuterClass)
		{
			...
			Z_Construct_UPackage__Script_AkAudio();
			OuterClass = UAkPortalComponent::StaticClass();
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				UObjectForceRegistration(OuterClass);
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<UAkPortalComponent> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(UAkPortalComponent, 112978183);
