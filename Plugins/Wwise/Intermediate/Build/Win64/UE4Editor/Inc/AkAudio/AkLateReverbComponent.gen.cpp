...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UAkLateReverbComponent()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_NextLowerPriorityComponent = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("NextLowerPriorityComponent"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(NextLowerPriorityComponent, UAkLateReverbComponent), 0x0010000000082008, Z_Construct_UClass_UAkLateReverbComponent_NoRegister());
				...
				MetaData->SetValue(NewProp_NextLowerPriorityComponent, TEXT("ModuleRelativePath"), TEXT("Classes/AkLateReverbComponent.h"));
	...
	IMPLEMENT_CLASS(UAkLateReverbComponent, 3019550218);
