...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UAkSettings()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bAutoConnectToWAAPI, UAkSettings);
				UProperty* NewProp_bAutoConnectToWAAPI = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bAutoConnectToWAAPI"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bAutoConnectToWAAPI, UAkSettings), 0x0010000000004001, CPP_BOOL_PROPERTY_BITMASK(bAutoConnectToWAAPI, UAkSettings), sizeof(bool), true);
				...
				MetaData->SetValue(NewProp_bAutoConnectToWAAPI, TEXT("Category"), TEXT("Installation"));
				MetaData->SetValue(NewProp_bAutoConnectToWAAPI, TEXT("ModuleRelativePath"), TEXT("Classes/AkSettings.h"));
	...
	IMPLEMENT_CLASS(UAkSettings, 29196775);
