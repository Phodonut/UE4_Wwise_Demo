...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EReflectionFilterBits(EReflectionFilterBits_StaticEnum, TEXT("/Script/AkAudio"), TEXT("EReflectionFilterBits"), false, nullptr, nullptr);
	...
	UFunction* Z_Construct_UFunction_UAkComponent_SetListeners()
	{
		...
		if (!ReturnFunction)
		{
			...
			MetaData->SetValue(ReturnFunction, TEXT("Category"), TEXT("Audiokinetic|AkComponent"));
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("Classes/AkComponent.h"));
			MetaData->SetValue(ReturnFunction, TEXT("ToolTip"), TEXT("Set a game object's listeners\n\n@param Listeners     The array of components that listen to this component"));
	...
	UFunction* Z_Construct_UFunction_UAkComponent_UseEarlyReflections()
	{
		...
		if (!ReturnFunction)
		{
			...
			UProperty* NewProp_MaxPathLength = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("MaxPathLength"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(MaxPathLength, AkComponent_eventUseEarlyReflections_Parms), 0x0010000000000080);
			UProperty* NewProp_BusSendGain = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("BusSendGain"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(BusSendGain, AkComponent_eventUseEarlyReflections_Parms), 0x0010000000000080);
			UProperty* NewProp_Order = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Order"), RF_Public|RF_Transient|RF_MarkAsNative) UUnsizedIntProperty(CPP_PROPERTY_BASE(Order, AkComponent_eventUseEarlyReflections_Parms), 0x0010000000000080);
	...
	UClass* Z_Construct_UClass_UAkComponent()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(DrawSoundPropagation, UAkComponent);
				UProperty* NewProp_DrawSoundPropagation = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("DrawSoundPropagation"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(DrawSoundPropagation, UAkComponent), 0x0010040000000005, CPP_BOOL_PROPERTY_BITMASK(DrawSoundPropagation, UAkComponent), sizeof(uint8), false);
				...
				UProperty* NewProp_EnableSpotReflectors = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("EnableSpotReflectors"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(EnableSpotReflectors, UAkComponent), 0x0010040000000015, CPP_BOOL_PROPERTY_BITMASK(EnableSpotReflectors, UAkComponent), sizeof(uint8), false);
				UProperty* NewProp_OcclusionCollisionChannel = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OcclusionCollisionChannel"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(CPP_PROPERTY_BASE(OcclusionCollisionChannel, UAkComponent), 0x0010000000000005, Z_Construct_UEnum_Engine_ECollisionChannel());
				UProperty* NewProp_EarlyReflectionMaxPathLength = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("EarlyReflectionMaxPathLength"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(EarlyReflectionMaxPathLength, UAkComponent), 0x0010040000000015);
				UProperty* NewProp_EarlyReflectionBusSendGain = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("EarlyReflectionBusSendGain"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(EarlyReflectionBusSendGain, UAkComponent), 0x0010040000000015);
				UProperty* NewProp_EarlyReflectionOrder = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("EarlyReflectionOrder"), RF_Public|RF_Transient|RF_MarkAsNative) UUnsizedIntProperty(CPP_PROPERTY_BASE(EarlyReflectionOrder, UAkComponent), 0x0010040000000015);
				UProperty* NewProp_EarlyReflectionAuxBusName = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("EarlyReflectionAuxBusName"), RF_Public|RF_Transient|RF_MarkAsNative) UStrProperty(CPP_PROPERTY_BASE(EarlyReflectionAuxBusName, UAkComponent), 0x0010040000000015);
				UProperty* NewProp_EarlyReflectionAuxBus = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("EarlyReflectionAuxBus"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(EarlyReflectionAuxBus, UAkComponent), 0x0010040000000015, Z_Construct_UClass_UAkAuxBus_NoRegister());
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkComponent_SetListeners(), "SetListeners"); // 1304133130
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkComponent_UseEarlyReflections(), "UseEarlyReflections"); // 2494437620
				...
				MetaData->SetValue(NewProp_DrawSoundPropagation, TEXT("Category"), TEXT("AkComponent|Spatial Audio|Debug Draw"));
				MetaData->SetValue(NewProp_DrawSoundPropagation, TEXT("ModuleRelativePath"), TEXT("Classes/AkComponent.h"));
				...
				MetaData->SetValue(NewProp_OcclusionCollisionChannel, TEXT("Category"), TEXT("AkComponent|Occlusion"));
				MetaData->SetValue(NewProp_OcclusionCollisionChannel, TEXT("ModuleRelativePath"), TEXT("Classes/AkComponent.h"));
	...
	IMPLEMENT_CLASS(UAkComponent, 3431274942);
